/*
 *  An on-going edit of the original, taking in all the new stuff
 *  that continue to plague the authoring of a client!
 *
 *  RCS: @(#) $Id: numeric.h,v 1.5 2002/08/14 15:02:41 davygrvy Exp $
 */


#ifndef INC_numeric_h__
#define INC_numeric_h__
...
#define RPL_LOAD2HI	     263    /* hybrid-5 */
#define RPL_TRYAGAIN         263    /* ircd2.9.5 */
