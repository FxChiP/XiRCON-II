...
LRESULT CALLBACK CmdBoxWndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam);
...
//	    CFE_PROTECTED |
    ...
    _tcscpy_s(defFmt.szFaceName, 32, TEXT("Courier New"));
    //defFmt.yHeight = 220;
...
#define ATTR_MIRC       "\003"
	...
	case WM_CHAR:
	{
		...
		case VK_RETURN:
		{
		    ...
		    gte.cb = 510;
		    gte.codepage = 1200; //unicode, in UTF-16.
